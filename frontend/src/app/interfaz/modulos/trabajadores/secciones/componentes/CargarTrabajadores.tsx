...
import type { ArchivoImportado, CargueProps, TrabajadorNormalizado } from '../../types/CargueImportarTypes';

import estilos from '../../estilos/EstilosCargueTrabajadores.module.css';
import { BasureroIcon, DocumentoPorDefectoIcono, ExcelIcono, IconoRestaurar, ImportarDocumento, ImportarIcono } from '../../recursos/IconosCargaTrabajadores';
import { validarTrabajadoresExcel } from '../../utilidades/FuncionCargueTrabajadores';
import { AsignarNombreTipo, eliminarArchivoDefinitivamente, iniciarCargaConReferencias, manejarArchivosSoltados, validarCamposRequeridos } from '../../utilidades/FuncionesCargue';
...
const CargarTrabajadores: React.FC<CargueProps> = ({
  close,
  titulo,
  rutaStorage,
  archivosCargados,
...
export default CargarTrabajadores;
