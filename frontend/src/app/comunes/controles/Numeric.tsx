...
import type { InputProps, SvgProps } from 'comunes/types/ControlesTypes';
...
export const ControlIconUp = styled.svg`
...
export const ControlIconDown = styled.svg`
  width: calc(var(--icons-size) * 0.6);
  height: calc(var(--icons-size) * 0.6);
  stroke: var(--color-primary-text);
  stroke-width: 2px;
